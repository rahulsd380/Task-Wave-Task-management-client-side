    ...
    <div className="px-5 shadow-lg border-b md:shadow-none md:border-none top-0 py-3">
      <div className="flex justify-between">
        ...
        <div className="flex items-center">
            ...
            {
              !user? <div className="hidden md:flex gap-5">
              <Link to={"/login"}>
              <button className="text-teal-500 border border-teal-400 font-semibold  rounded-md h-11 hover:bg-emerald-400 transition duration-300 hover:text-white px-6">Login</button>
              </Link>

              <Link to={"/signup"}>
              <button className="text-white bg-gradient-to-r from-emerald-300 to-emerald-500 font-semibold  rounded-md h-11 px-6">Sign Up</button>
              </Link>
              </div>
              : 
              ""
